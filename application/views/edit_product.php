...
<?php echo form_open_multipart("product/edit/$product_id");?>
  ...
  <tr>
		...
		<tr>
			...
			<td><?php ///echo form_input($picture); ?><input type="file" id="profile_img" name="profile_img" size="33" /><img src="<?php echo base_url();?>images/products/<?php echo $picture;?>" width="100"/></td>
		</tr>
  <tr>
		...
		<tr>
			<td>&nbsp;</td>
			<td><?php echo form_submit('submit', 'Update',"class='btn btn-success'");?>
